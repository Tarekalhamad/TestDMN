 ...
 * under the License.
 */
package https_58_47_47telenor_46se_47promotion_45compatibility;
...
@RestController
@RequestMapping("/PromotionCompatibility")
public class PromotionCompatibilityResource {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/PromotionCompatibility.json#/definitions/InputSet")), description = "DMN input")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/PromotionCompatibility.json#/definitions/OutputSet")), description = "DMN output")
    public ResponseEntity<?> dmn(@RequestBody(required = false) java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://telenor.se/promotion-compatibility", "PromotionCompatibility");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://telenor.se/promotion-compatibility", "PromotionCompatibility", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("PromotionCompatibility") + ".dmn_nologic")) {
